...
**Groq note:** one collect run uses 1–3 chat calls (usually 1). Enrichment is additive narrative; entry/stop/T1/hold still come from Parkhu gates. Rotate any key that was exposed in chat.
