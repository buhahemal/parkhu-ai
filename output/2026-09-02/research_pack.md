...
- AJANTPHARM: {'trade_id': '2026-08-13-AJANTPHARM', 'symbol': 'AJANTPHARM', 'company': 'Ajanta Pharma Limited', 'risk_sector': 'Health Technology', 'date_opened': '2026-08-13', 'taken': None, 'entry': 3614.6, 'stop': 3420.26, 't1': 4003.29, 't2': 4197.63, 't3': 4391.97, 'structure_invalidation': 3342.43, 'horizon_days_t1': 17, 'horizon_days_t2': 22, 'score_at_open': 82.3, 'qty': 2, 'risk_rupees': 389.0, 'status': 'closed', 'last_price': 3446.9, 'last_checked': '2026-09-02', 'mfe_pct': 5.02, 'mae_pct': -5.11, 'gap_flag': False, 'hit_t1': False, 'hit_t2': False, 'reconfirmed_count': 3, 'notes': None, 'date_closed': '2026-09-02', 'exit_price': 3446.9, 'exit_reason': 'invalidated', 'pct_return': -4.64, 'r_multiple': -0.86, 'days_held': 14}
- KENNAMET: {'trade_id': '2026-08-15-KENNAMET', 'symbol': 'KENNAMET', 'company': 'Kennametal India Limited', 'risk_sector': 'Producer Manufacturing', 'date_opened': '2026-08-15', 'taken': None, 'entry': 3513.3, 'stop': 3232.24, 't1': 4075.43, 't2': 4356.49, 't3': 4637.56, 'structure_invalidation': 3001.23, 'horizon_days_t1': 14, 'horizon_days_t2': 22, 'score_at_open': 88.7, 'qty': 2, 'risk_rupees': 562.0, 'status': 'closed', 'last_price': 4673.5, 'last_checked': '2026-09-02', 'mfe_pct': 38.33, 'mae_pct': -0.95, 'gap_flag': False, 'hit_t1': True, 'hit_t2': True, 'reconfirmed_count': 9, 'notes': None, 'date_closed': '2026-09-02', 'exit_price': 4673.5, 'exit_reason': 't3', 'pct_return': 33.02, 'r_multiple': 4.13, 'days_held': 13}
- LAURUSLABS: {'trade_id': '2026-08-31-LAURUSLABS', 'symbol': 'LAURUSLABS', 'company': 'Laurus Labs Ltd.', 'risk_sector': 'Health Technology', 'date_opened': '2026-08-31', 'taken': None, 'entry': 1915.0, 'stop': 1825.11, 't1': 2094.77, 't2': 2184.66, 't3': 2274.54, 'structure_invalidation': 1769.4, 'horizon_days_t1': 16, 'horizon_days_t2': 22, 'score_at_open': 81.8, 'qty': 5, 'risk_rupees': 449.0, 'status': 'closed', 'last_price': 1818.3, 'last_checked': '2026-09-02', 'mfe_pct': 1.78, 'mae_pct': -5.1, 'gap_flag': False, 'hit_t1': False, 'hit_t2': False, 'reconfirmed_count': 2, 'notes': None, 'date_closed': '2026-09-02', 'exit_price': 1818.3, 'exit_reason': 'stop', 'pct_return': -5.05, 'r_multiple': -1.08, 'days_held': 2}
...
- pack json: https://raw.githubusercontent.com/buhahemal/parkhu-ai/main/output/2026-09-02/research_pack.json
